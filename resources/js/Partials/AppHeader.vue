<template>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <inertia-link :href="$route('employee.index')" class="navbar-brand">Employee App</inertia-link>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <inertia-link :href="$route('employee.index')" class="nav-link">Home</inertia-link>
                    </li>
                    <li class="nav-item">
                        <inertia-link :href="$route('employee.create')" class="nav-link">Add Employee</inertia-link>
                    </li>
                </ul>
            </div>
